...
const readme = read("README.md");
 ...
 describe("portable Python runtime contract", () => {
  ...
  it("selects override, bundled runtime and system fallback in that order", () => {
    ...
    expect(interpreter).toContain("python/install");
  });
  ...
  it("opens the built Debian package and executes the embedded interpreter", () => {
    expect(ciWorkflow).toContain("dpkg-deb -x");
    expect(ciWorkflow).toContain("python-runtime/python/install/bin/python3");
